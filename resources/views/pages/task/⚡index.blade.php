...
<div class="min-h-screen bg-gray-50 py-10 dark:bg-gray-950">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex items-center justify-between">
            ...
            <button type="button" wire:click="createTask" class="rounded-lg bg-gray-900 px-4 py-2 text-sm font-medium text-white hover:bg-gray-700 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-200">
                + New Task
            </button>
        </div>
        ...
        @if ($showForm)
            <div class="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="task-form-title">
                ...
                <div class="relative w-full max-w-md rounded-xl bg-white p-6 shadow-xl dark:bg-gray-900">
                    ...
                    <form wire:submit="saveTask" class="space-y-5">
                        <div>
                            <label for="task-name" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                                Task name
                            </label>
                        ...
                        <div>
                            <label for="task-project" class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">
                                Project
                            </label>
        ...
        <div
            ...
            @forelse ($this->tasks as $task)
                <div wire:key="task-{{ $task->id }}"
                     class="flex items-center gap-4 border-b border-gray-100 px-6 py-4 last:border-b-0 dark:border-gray-800">
